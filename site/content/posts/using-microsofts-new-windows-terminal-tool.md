---
title: 'Using Microsofts New Windows Terminal Tool'
description: "First impressions of Microsoft's Windows Terminal app, including useful pane-splitting shortcuts and how it compares to PuTTY."
pubDate: 2020-12-15
...
[![Terminal split screen](/images/using-microsofts-new-windows-terminal-tool/Terminal-split-screen-1024x572.png)](/images/using-microsofts-new-windows-terminal-tool/Terminal-split-screen.png)
I have to say that I am by no means a power user. This tool hasn't been able to fully replace PuTTY for me due to some features that I use from time to time (telnet and serial ports), but I am sure if I took more time to figure out this tool it could be a very good replacement. To find out more check out the documentation: [https://docs.microsoft.com/en-us/windows/terminal/](https://docs.microsoft.com/en-us/windows/terminal/)
